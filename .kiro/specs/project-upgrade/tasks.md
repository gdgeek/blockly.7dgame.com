...
- [ ] 2. Blockly 核心及插件升级 (需求 9)
  - [ ] 2.1 升级 package.json 中的 Blockly 相关依赖版本
...
- [ ] 9. App.vue 职责拆分 (需求 5)
  ...
  - [ ] 9.4 创建 src/composables/useWorkspace.ts
    ...
    - _需求: 5.2_
  - [ ] 9.5 重构 App.vue 使用新的 composable 模块
...
- [ ] 10. 工作区加载机制重构 (需求 7)
  - [ ] 10.1 在 useWorkspace.ts 中实现事件驱动的工作区加载
...
- [ ] 12. 测试覆盖补全 (需求 2)
  ...
  - [ ] 12.5 编写代码生成器的单元测试
    ...
    - _需求: 2.2, 2.3_
  - [ ] 12.6 编写 useMessageBridge 通信逻辑的单元测试
