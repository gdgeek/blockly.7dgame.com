...
const FRIENDLY_TOOLTIP_BY_BLOCK: Record<string, TooltipLocalization> = {
  ...
  "task_array": {
    "zh-CN": "把多个任务按顺序组合成一个任务组，便于统一执行。",
    "en-US": "Combines multiple tasks into one ordered task group.",
    "ja-JP": "複数タスクを順序付きの1つのグループにまとめます。",
    "zh-TW": "把多個任務按順序組合成一個任務組，便於統一執行。",
    "th-TH": "รวมหลายงานเป็นกลุ่มงานเดียวตามลำดับ เพื่อเรียกใช้พร้อมกัน",
  },
  "task-circle": {
