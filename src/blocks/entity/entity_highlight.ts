...
const block: BlockDefinition = {
  ...
  getBlockJson(_parameters: unknown): object {
    ...
    const json = {
      type: "block_type",
      message0: Msg["ENTITY_ENTITY_HIGHLIGHT"][window.lg],
      args0: [
        {
          type: "input_value",
          name: "entity",
        ...
        const newOptions: [string, string][] =
          boolValue === "TRUE"
            ...
            : [
                [
                  (
                    Blockly.Msg as unknown as Record<
                      string,
                      Record<string, string>
                    >
                  )["COLOR_NONE"][window.lg],
                  "none",
                ],
              ];
  ...
  getJavascript(
    ...
    const script = function (
      ...
      const code = `point.setHighlight(${value_entity}, ${value_bool}, ${quoteJavaScriptString(
        value_color
      )});\n`;
      return code;
    };
