                    ...
                    options: function () {
                        ...
                        if (this.sourceBlock_) {
                            ...
                            if (bookUuid && resource && resource.phototype) {
                                const book = resource.phototype.find(i => i.uuid === bookUuid);
                                if (book && book.data && book.data.context) {
                                    try {
                                        const contextObj = typeof book.data.context === 'string'
                                        ...
                                        console.error("Failed to parse book context for Page options", e);
                                    }
                                }
                            }
                        }
