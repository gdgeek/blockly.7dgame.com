...
javascriptGenerator.forBlock["stock_buy_simple"] = function (
  block: Blockly.Block,
...
Lua.luaGenerator.forBlock["stock_buy_prog"] = function (
  block: Blockly.Block,
...
javascriptGenerator.forBlock["stock_buy_prog"] = function (
  block: Blockly.Block,
  generator: JavascriptGenerator
): string {
  const valueNumber = generator.valueToCode(block, "Number", Order.ATOMIC);
